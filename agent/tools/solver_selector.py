...
_SOLVERS = {
    ...
    "ipopt": {
        ...
        "type": "open_source",
        "supports": ["NLP", "MINLP"],
        "install": "pip install cyipopt",
        "pyomo_name": "ipopt",
        "strengths": "Best open-source NLP solver, interior point method",
        "limitations": "Requires C library (cyipopt wrapper)",
        "param_tuner": lambda pt, sz: {"max_iter": 3000, "tol": 1e-8},
    },
    "ecos": {
        "name": "ECOS",
        "type": "open_source",
        "supports": ["Convex", "SOCP", "QP"],
        "install": "pip install cvxpy",
        "pyomo_name": None,
        "cvxpy_name": "ECOS",
        "strengths": "Fast for convex problems, embedded cone solver",
        "limitations": "Only for convex problems, no MIP support",
        "param_tuner": lambda pt, sz: {},
    },
    "scs": {
        "name": "SCS",
        "type": "open_source",
        "supports": ["Convex", "SOCP", "SDP", "QP"],
        "install": "pip install cvxpy",
        "pyomo_name": None,
        "cvxpy_name": "SCS",
        "strengths": "Supports SDP, scalable for large problems",
        "limitations": "Lower accuracy than ECOS",
        "param_tuner": lambda pt, sz: {"max_iters": 10000},
    },
    "osqp": {
        "name": "OSQP",
        "type": "open_source",
        ...
        "pyomo_name": None,
        "cvxpy_name": "OSQP",
        "strengths": "Excellent for QP, warm starting",
        "limitations": "Only for QP and LP",
        "param_tuner": lambda pt, sz: {"max_iter": 10000},
    },
}
